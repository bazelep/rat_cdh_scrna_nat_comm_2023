...
donor.order.map[["E215_NitrofenControl"]] = c(1,0,2,3,4) + 1
donor.order.map[["E215_NitrofenCDH"]] = c(0,3,4,1,2) + 1
donor.order.map[["New_E215_HealthyControl"]] = c(2,3,1,0,4) + 1
donor.order.map[["Original_E215_HealthyControl"]] = c(2,3,1,0,4) + 1
