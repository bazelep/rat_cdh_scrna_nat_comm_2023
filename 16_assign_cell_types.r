...
pdf(file=paste0("../Graphs/Clusters/2HC,NC,CDH.Labeled.FullLabel.pdf"))
...
pdf(file=paste0("../Graphs/Clusters/2HC,NC,CDH.Labeled.Cell.Type.1.pdf"))
for(s in c("2HC","NC","CDH")){
  print(s)
...
pdf(file=paste0("../Graphs/Clusters/2HC,NC,CDH.Labeled.Cell.Type.2.pdf"))
for(s in c("2HC","NC","CDH")){
  print(s)
